/* Gforth virtual machine (aka inner interpreter)
  ...
  Copyright (C) 1995,1996,1997,1998,2000,2003,2004,2005,2006,2007,2008,2010,2011,2012,2013,2014,2015,2016,2019,2020,2021,2022,2023,2024,2025 Free Software Foundation, Inc.
...
#define vm_x2Cell(_x,_cell)		((_cell)=(Cell)(_x))
...
#elif defined(ASMCOMMENT) && !defined(__clang__)
...
#define LABEL_UU(name) H_##name: I_##name:
#define LABEL3(name) J_##name: { }
#define LABEL3_UU(name) J_##name: { }
#else
...
#define LABEL2_UU(name) K_##name:

#define LABEL1(name) L_##name: { }
#else
